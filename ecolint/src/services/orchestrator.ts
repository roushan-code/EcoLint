  ...
  private async stepCompare(): Promise<BenchmarkComparison | undefined> {
    ...
    return {
      original: {
        ...
        name: 'original',
        language: 'typescript',
        runtimeMs: original.runtimeMs,
        cpuPercent: original.cpuPercent,
        memoryMB: original.memoryMB,
        estimatedPowerW: original.estimatedPowerW,
        estimatedEnergyWh: original.estimatedEnergyWh,
        estimatedCarbonGrams: original.estimatedCarbonGrams,
      ...
      optimized: {
        ...
        cpuPercent: optimized.cpuPercent,
        memoryMB: optimized.memoryMB,
        estimatedPowerW: optimized.estimatedPowerW,
        estimatedEnergyWh: optimized.estimatedEnergyWh,
        estimatedCarbonGrams: optimized.estimatedCarbonGrams,
        stdout: optimized.stdout || '',
        stderr: optimized.stderr || '',
        exitCode: optimized.exitCode,
        timestamp: optimized.timestamp,
      },
      improvement: {
        runtimePercent: ((original.runtimeMs - optimized.runtimeMs) / original.runtimeMs) * 100,
        memoryPercent: ((original.memoryMB - optimized.memoryMB) / original.memoryMB) * 100,
        carbonPercent: ((original.estimatedCarbonGrams - optimized.estimatedCarbonGrams) / original.estimatedCarbonGrams) * 100,
      },
    };
  }
